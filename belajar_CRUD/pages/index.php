            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="lihat_tabel.php"><i class="fa fa-table fa-fw"></i> Lihat Tabel</a>
                        </li>
                        <li>
                            <a href="input.php"><i class="fa fa-edit fa-fw"></i> Tambah Data Pegawai</a>
                        </li>
                        <li>
                            <a href="edit.php"><i class="fa fa-edit fa-fw"></i> Ubah Data Pegawai</a>
                        </li>
                        <li>
                            <a href="hapus.php"><i class="fa fa-edit fa-fw"></i> Hapus Data Pegawai</a>
                        </li>
                      </li>
