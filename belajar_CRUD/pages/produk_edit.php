...
<head>
    ...
    <title>Edit Data Produk - PT. Multi Instrumentasi</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <!-- /.col-lg-12 -->
                <div class="col-lg-12">
                  <form action="produk_edit_aksi.php" method="post">
                    <div class="form-group">
                        <label>Nama Produk</label>
                        <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                        <input class="form-control" type="text" name="namaproduk" value="<?php echo $data['nama_produk']; ?>">
                    </div>
                    <div class="form-group">
                        <label>Harga Satuan</label>
                        <input class="form-control" type="text" name="hargasatuan" value="<?php echo $data['harga']; ?>">
                    </div>
